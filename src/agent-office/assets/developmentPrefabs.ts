...
export const DEVELOPMENT_PREFABS:PrefabDefinition[]=[
  ...
  prefab({
    ...
    sockets:[
      ...
      {id:'seat4',kind:'work',x:115,y:310,facing:'north',pose:'seated-working',tags:['workstation','4']},
      {id:'seat5',kind:'work',x:310,y:310,facing:'north',pose:'seated-working',tags:['workstation','5']},
      {id:'seat6',kind:'work',x:505,y:310,facing:'north',pose:'seated-working',tags:['workstation','6']},
    ],
    collision:[
  ...
  prefab({
    ...
    keepClear:[{x:0,y:335,width:330,height:25}],
