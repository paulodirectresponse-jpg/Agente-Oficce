...
export class DelegationService{
 ...
 validate(req:DelegationRequest){
  ...
  if(req.team_id&&Array.isArray(teamPolicy.allowed_tools)&&teamPolicy.allowed_tools.length&&(req.required_tools??[]).some(t=>!teamPolicy.allowed_tools.includes(t)))throw new Error('DELEGATION_TEAM_TOOL_BLOCKED');
